...
int __cdecl wmain(int argc, _In_reads_(argc) WCHAR** argv)
{
    ...
    pwszConnStr = L"Driver={SQL Server};Server=cs215-224307.mssql.somee.com;Database=cs215-224307;Uid=m224307_SQLLogin_1;Pwd=mnzmq2zyh7;";
    ...
    while (choice != -1)
    {
        ...
        int collegeChoice = 10;
        cout << "==============================" << endl;
        cout << "=         Main Menu          =" << endl;
        cout << "==============================" << endl;
        cout << "1: Patient" << endl;
        cout << "2: Colleges Menu" << endl;
        cout << "-1: Exit" << endl;
        cout << "Choice: ";
        cin >> choice;
        switch (choice)
        ...
        case 1:
            while (studentChoice != -1)
            {
                ...
                case 2:
                    ...
                    cout << "First name: ", cin >> P_Fname;
                    cout << "Last name: ", cin >> P_Lname;
                    cout << "Enter Patient Blood type: ", cin >> P_Blood_type;
                    convert("insert into Patient values(" + P_ID + ",'" + P_Fname + "','" + P_Lname + "','" + P_Blood_type + "')", wszInput);
                    //cout<< "insert into students values(" + stdID + ",'" + stdName + "','" + stdCollege + "')" <<endl;
                    ExecuteSQLStmt(wszInput, hStmt);
                    cout << "Done" << endl;
                    break;
                case 3:
                    cout << "==============================" << endl;
                    cout << "Enter Patient ID to delete: ", cin >> P_ID;
                    convert("delete from Patient where  P_ID = " + P_ID, wszInput);
                    //cout << "delete from Students where id = " + stdID << endl;
                    ExecuteSQLStmt(wszInput, hStmt);
                    cout << "Done" << endl;
                    break;
                case 4:
                    cout << "==============================" << endl;
                    cout << "Enter Patient ID to update: ", cin >> P_ID;
                    cout << "Enter the new First  name: ", cin >> P_Fname;
                    cout << "Enter the new  Last  name: ", cin >> P_Lname;
                    cout << "Enter the new Blood type: ", cin >> P_Blood_type;
                    convert("update Patient set P_Fname = '" + P_Fname + " ' , P_Lname = '" + P_Lname + " ', P_Blood_type = '" + P_Blood_type + "' where P_ID = " + P_ID, wszInput);
                    //cout << "update Students set student_name = '" + stdName + " ', college_name = '" + stdCollege + "' where id = " + stdID << endl;
                    ExecuteSQLStmt(wszInput, hStmt);
                    cout << "Done" << endl;
                    break;
                }
            ...
            break;
        case 2:
            while (collegeChoice != -1)
            {
                cout << "==============================" << endl;
                cout << "=       Colleges Menu        =" << endl;
                cout << "==============================" << endl;
                cout << "1: Show All Colleges" << endl;
                cout << "2: Insert new College" << endl;
                cout << "3: Delete current College" << endl;
                cout << "4: Update current College" << endl;
                cout << "-1: Back to the main menu" << endl;
                cout << "Choice: ";
                cin >> collegeChoice;
                ...
                case 1:
                    cout << "==============================" << endl;
                    convert("Select * from Colleges", wszInput);
                    ExecuteSQLStmt(wszInput, hStmt);
                    break;
                case 2:
                    cout << "==============================" << endl;
                    ...
                    cin >> hours;
                    convert("insert into colleges values('" + P_Blood_type + "'," + hours + ")", wszInput);
                    ExecuteSQLStmt(wszInput, hStmt);
                    cout << "Done" << endl;
                    break;
                case 3:
                    cout << "==============================" << endl;
                    cout << "Enter college name to delete: ";
                    cin >> P_Blood_type;
                    convert("delete from Colleges where name = '" + P_Blood_type + "'", wszInput);
                    ExecuteSQLStmt(wszInput, hStmt);
                    cout << "Done" << endl;
                    break;
                case 4:
                    cout << "==============================" << endl;
                    cout << "Enter College name to update: ";
                    cin >> P_Blood_type;
                    cout << "Enter the hours: ";
                    cin >> hours;
                    convert("update Colleges set hours = " + hours + " where name = '" + P_Blood_type + "'", wszInput);
                    ExecuteSQLStmt(wszInput, hStmt);
                    cout << "Done" << endl;
                    break;
                }
